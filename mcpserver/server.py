...
@mcp.tool(name="dataquality", description="Assess Data Quality by starting a new conversation in a Genie space using space_id: The ID associated with the Genie space where you want to start a conversation, content: The text of the message that starts the conversation.")
async def dataquality(space_id: str, content: str) -> Dict[str, Any]:
    """Assess Data Quality by starting a new conversation in a Genie space.
    ...
    try:
        ...
        response = {
            ...
            "attachments": [a.as_dict() for a in getattr(message, 'attachments', [])]
        }
        ...
        if message.attachments:
            ...
            if result.statement_response:
                full_response["query_result"] = result.statement_response.as_dict()
        return full_response
    except Exception as e:
        return {"error": f"Error starting conversation: {str(e)}, space_id {space_id}, conversation_id {conversation_id}, message_id {message_id}, attachment_id {attachment_id}"}


@mcp.tool(name="start_conversation", description="Start a new conversation in a Genie space using space_id: The ID associated with the Genie space where you want to start a conversation, content: The text of the message that starts the conversation.")
...
@mcp.tool(name="create_message", description="Create a new message in an existing conversation. Using space_id: The ID associated with the Genie space where the conversation is located, conversation_id: The ID of the conversation, content: The text of the new message")
...
@mcp.tool(name="get_message", description="Get a message from a conversation using space_id: The ID associated with the Genie space where the conversation is located, conversation_id: The ID of the conversation, message_id: The ID of the message to retrieve.")
...
@mcp.tool(name="get_message_attachment_query_result", description="Get the SQL query result from a message attachment using space_id: The ID of the Genie space, conversation_id: The ID of the conversation, message_id: The ID of the message, attachment_id: The ID of the query attachment.")
async def get_message_attachment_query_result(
    ...
    try:
        ...
        return {"error": f"Error retrieving query result: {str(e)} result - {result.statement_response.as_dict()}"}

@mcp.tool(name="execute_message_attachment_query", description="Execute the SQL query for a message attachment using space_id: The ID of the Genie space, conversation_id: The ID of the conversation, message_id: The ID of the message, attachment_id: The ID of the query attachment.")
...
@mcp.tool(name="get_space", description="Get details of a Genie Space using space_id: The ID of the Genie space to retrieve details for.")
...
@mcp.tool(name="generate_download_full_query_result", description="Generate full query result download using space_id: The ID of the Genie space, conversation_id: The ID of the conversation, message_id: The ID of the message, attachment_id: The ID of the query attachment.")
...
@mcp.tool(name="poll_message_until_complete", description="Poll a message until its status is COMPLETED or until timeout using space_id: The ID of the Genie space, conversation_id: The ID of the conversation, message_id: The ID of the message, timeout_seconds: Maximum time to poll (default: 10 minutes), poll_interval_seconds: Time between polls (default: 5 seconds).")
